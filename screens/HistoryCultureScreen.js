...
const HISTORY_CULTURE_DATA = [
    {
        ...
        description: 'Korea has a rich history spanning over 5,000 years, from ancient kingdoms to modern times...',
        icon: 'history',
    },
    {
        id: '2',
        title: 'Korean Traditional Culture',
        description: 'Korean traditional culture includes various aspects such as Hanbok (traditional clothing), traditional music, dance, and more...',
        icon: 'palette',
    },
    {
        id: '3',
        title: 'Korean Food Culture',
        description: 'Korean cuisine is known for its bold flavors, variety of side dishes and has been influenced by natural and cultural trends...',
        icon: 'restaurant',
    },
];
